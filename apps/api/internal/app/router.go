...
func (a *App) setupRoutes() {
	...
	api.Get("/galgame-tag/:name", a.GalgameHandler.GetTagDetail)
	...
	api.Get("/galgame-engine", a.GalgameHandler.GetEngineList)
	api.Get("/galgame-engine/:name", a.GalgameHandler.GetEngineDetail)
	...
	authed.Get("/message/nav/contact", a.MessageHandler.GetNavContact)
	authed.Get("/message/chat/history", a.MessageHandler.GetChatHistory)
	authed.Post("/message/chat/send", a.MessageHandler.SendChatMessage)
